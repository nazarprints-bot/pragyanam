    ...
    <section id="courses" className="py-20 lg:py-28 bg-cream">
      <div className="max-w-6xl mx-auto px-5">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
          <p className="text-[12px] font-semibold text-accent uppercase tracking-widest mb-3">{t("courses.label")}</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground tracking-tight mb-3">{t("courses.title")}</h2>
          <p className="text-[15px] text-muted-foreground max-w-md mx-auto">{t("courses.subtitle")}</p>
        </motion.div>
